...
[
	{ div:["tt",""], u:[null,"contacts_uuid"] }, // caller 

	{ div:["",""], u:["case_form_reporter","reporters"] }, // reporter
...
[		
	...
	[
		...
		[
			...
			{ u:["case_uuid_arg","case_uuid"] }
		]},
	]}
]};

te["case_ed"] = { case_form_:["%0", "case_form_contact_followup", "case_ed-cases","Update", "","_uvw", DISPOSITION_ID_FOLLOWUP] };

te["case_new"] = { case_form_:["NEW CASE", "case_form_contact_new_case", "case_new-cases","Create", "","_uvw", DISPOSITION_ID_COMPLETE] };
