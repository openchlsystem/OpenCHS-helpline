...
[
	{ div:["","vb"], c:[ { p:["","o"], c:
	[
		{ div:[], c:[ { input:["g","","age_t","0","radio"] }, { ac:["c w07 rc_","","_tab","x03 y","Age"] } ] },
		{ div:[], c:[ { input:["g","","age_t","1","radio"] }, { ac:["c w07 rc_","","_tab","xx y ","DOB"] } ] },
		{ div:[], c:[ { input:["g","","age_t","2","radio","1"] }, { ac:["d w07 rc_","","_tab","y tr","Age Group"] } ] }, 
		{ div:["e"] }
	]} ]},
	{ div:["","vaa"], c: 
	[
