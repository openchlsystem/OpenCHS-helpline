...
(
	array ("reporters","","dup","id","reporter_id", NULL, "contact_id:contact_id"), // get contact_id
	array ("contacts","_dup","include"),
	array ("cases","","dup","id","case_id_",NULL, "id", "uuid"),
...
(
	...
	array ("cases",     "","dup","id","case_id",NULL, "id","reporter_id:reporter_id"), // todo: use reporter_uuid instead to capture current reporter
...
(
	...
	array ("cases","","lvl","case_category_fullname_id","5","^",":", "cat_","id_",""), // split cat levels
        array ("cases","","params", "activity","::case_id: case_new: case_edit", "reporter_id","::case_id:reporter_uuid_id:reporter_id"),
	array ("reporters","_dup","include"),
        array ("cases","","aub"),
	array ("cases","",""), 
	
	array ("cases","","params", "case_id_","case_id", "uuid","uuid"),
