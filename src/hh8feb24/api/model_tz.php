...
(
	...
	"dispositions"=>	array ("disposition","dsp",	"3","0","0",	"Dispositions", 	"src_ts DESC","",	""), 
...
(
	...
	array ("hangup_status_txt","",		"0","2","","",   "","","",   "Hangup Status","::hangup_status:0:1"),  
        array ("sla_band_queue","",		"0","2","","",   "","","",   "SLA Band","::sla:0:1:"), 
        array ("sla_band_hold","",		"0","2","","",   "","","",   "SLA Band","::sla:0:1:"), 
	...
	array ("qa_score","",			"4","2","","",   "qas","total_score_p","",   	"QA Score",""), 
        ...
        array ("dispositions","",		"4","1","","",  "dispositions", "GROUP_CONCAT(DISTINCT disposition)","",	"Dispositions",""),  
	//array ("contacts","",			"4","1","","",  "dispositions", "GROUP_CONCAT(DISTINCT repoter_fullname)","",	"Dispositions",""),  
	array ("tasks","",			"4","1","","",  "dispositions", "GROUP_CONCAT(IF(case_id>0,case_id,NULL))","",	"Cases",""),  
	
        array ("has_case_id","",		"4","2","","",  "dispositions", "IF(SUM(IF(case_id>0,1,0))>0,1,0)","",     	"Has Case ID",""),  		
        array ("reporters_fullname","",		"4","1","","",  "dispositions", "GROUP_CONCAT(IF(case_id>0,case_id,NULL))","",	"CaseIDs",""),
        array ("reporters_age_group","",	"4","1","","",  "dispositions", "GROUP_CONCAT(IF(case_id>0,case_id,NULL))","",	"CaseIDs",""),
        array ("reporters_sex","",		"4","1","","",  "dispositions", "GROUP_CONCAT(IF(case_id>0,case_id,NULL))","",	"CaseIDs",""),
        array ("reporters_location","",		"4","1","","",  "dispositions", "GROUP_CONCAT(IF(case_id>0,case_id,NULL))","",	"CaseIDs",""),
        array ("reporters_national_id_type","",	"4","1","","",  "dispositions", "GROUP_CONCAT(IF(case_id>0,case_id,NULL))","",	"CaseIDs",""),
        array ("reporters_nationality","",	"4","1","","",  "dispositions", "GROUP_CONCAT(IF(case_id>0,case_id,NULL))","",	"CaseIDs",""),
        array ("reporters_lang","",		"4","1","","",  "dispositions", "GROUP_CONCAT(IF(case_id>0,case_id,NULL))","",	"CaseIDs",""),
        array ("reporters_tribe","",		"4","1","","",  "dispositions", "GROUP_CONCAT(IF(case_id>0,case_id,NULL))","",	"CaseIDs",""),
...
(
	...
	array ("src_uid","",			"1","2","m","",	"","","", 	"Channel Uniqueid",""),
	array ("src_ts","",			"1","2","m","",	"","","", 	"Channel Timestamp",""),
	array ("src_address","",		"1","2","m","P","","","", 	"Channel Address",""),
	array ("src_usr","",			"1","2","","",	"","","", 	"Channel User",""),
	array ("src_vector","",			"1","2","m","",	"","","", 	"Channel Direction",""),
	array ("src_msg","",			"1","2","","",	"","","", 	"Channel Message",""),
	array ("gateway_msg_id","",		"1","2","m","",	"","","", 	"Gateway ID",""),
	array ("gateway_session_id","",		"1","2","m","",	"","","", 	"Gateway Session ID",""),
...
(
	...
	array ("pmsg_id","",			"1","2","","f",	"","","", 	"First Msg ID",""),
);
...
(
	...
	array ("action_count","",		"4","4","","",	"actions","COUNT(id)","",		"Action Count",""), // last action id					
	array ("action_id","",			"4","2","","",	"actions","MAX(id)","last_action_id",	"Action ID",""), // last action id					
	array ("action_on","",			"5","2","","",	"actions","created_on","",	"Action On",""), 						 
	array ("action_by_id","",		"5","2","","",  "actions","created_by_id","",	"Action By ID",""),
	array ("action_by","",			"5","2","","",  "actions","created_by","",	"Action By",""),
	array ("action_by_role","",		"5","2","","",  "actions","created_by_role","", "Action By Role",""),
	array ("action","",			"5","2","","",	"actions","action","",		"Action",""), // last action						 
	array ("action_detail","",		"5","1","","",  "actions","detail","",		"Detail",""),  
		
	// nb: dispostions are separate from ations but dispositions also log actions  
...
(
	...
	array ("disposition_id","",		"3","2","","f", "","","",	"Disposition ID",""), 
	...
	array ("reporter_id","",		"3","2","","f", "","","",				"Reporter ID",""),
	array ("reporter_contact_id","",	"3","2","","",	"reporters","contact_id","",		"Reporter Contact ID",""),
	...
	array ("reporter_sex_id","",		"3","2","","",  "reporters","contact_sex_id","",	"Reporter Gender",""),
...
(
	...
	array ("case_id_","",			"3","2","","", "","","",	"Case Link ID",""),
	array ("ca_id","",			"1","2","","",	"","","", 	"Case Update ID",""), 		
	array ("category_id","",		"1","2","m","f",	"","","",	"Refered To ID",""), 
	array ("category_name","",		"1","2","","",	"","","", 	"Refered To",""),
	array ("category_fullname","",		"1","2","","",	"","","", 	"Fullname",""),
	array ("category_fullname_id","",	"1","1","","",	"","","", 	"Fullname ID",""), 
);
...
(
	...
	array ("gbv_related","",		"3","2","","", "","","", 	"GBV Related","::yesno:0:2"),
	...
	array ("reporter_contact_id","",	"1","2","","",	"reporters","contact_id","",		"Reporter Contact ID",""),
	array ("reporter_fullname","",		"1","1","","",  "reporters","contact_fullname","",	"Reporter Fullname",""),
	array ("reporter_phone","",		"1","2","","",  "reporters","contact_phone","",		"Reporter Phone",""),
	array ("reporter_email","",		"1","2","","",  "reporters","contact_email","",		"Reporter Email",""),
	array ("reporter_phone2","",		"1","2","","",  "reporters","contact_phone2","",	"Reporter Alternative Contact",""),
	array ("reporter_national_id","",	"1","2","","",  "reporters","contact_national_id","",	"Reporter National ID",""),
	array ("reporter_landmark","",		"1","2","","",  "reporters","contact_landmark","",	"Reporter Nearest Landmark",""),
	array ("reporter_dob","",		"1","3","","",  "reporters","contact_dob","",		"Reporter Date of Birth","d M Y H:i:s"),
	array ("reporter_age","",		"1","2","","",  "reporters","contact_age","",		"Reporter Age",""),
	array ("reporter_age_group_id","",	"1","2","","",  "reporters","contact_age_group_id","",	"Reporter Age Group",""),
	array ("reporter_age_group","",		"1","2","","",  "reporters","contact_age_group","",	"Reporter Age Group",""),
	array ("reporter_sex_id","",		"1","2","","",  "reporters","contact_sex_id","",	"Reporter Gender",""),
	array ("reporter_sex","",		"1","2","","",  "reporters","contact_sex","",		"Reporter Gender",""),
	array ("reporter_national_id_type_id","","1","2","","", "reporters","contact_national_id_type_id","",	"ID Type ID",""),
	array ("reporter_national_id_type","",	"1","2","","",  "reporters","contact_national_id_type","",	"ID Type",""),
	array ("reporter_nationality_id","",	"1","2","","",  "reporters","contact_nationality_id","","Reporter Nationality ID",""),
	array ("reporter_nationality","",	"1","2","","",  "reporters","contact_nationality","",	"Reporter Nationality",""),
	array ("reporter_tribe_id","",		"1","2","","",  "reporters","contact_tribe_id","",	"Reporter Tribe ID",""),
	array ("reporter_tribe","",		"1","2","","",  "reporters","contact_tribe","",		"Reporter Tribe",""),
	array ("reporter_lang_id","",		"1","2","","",  "reporters","contact_lang_id","",	"Reporter Language ID",""),
	array ("reporter_lang","",		"1","2","","",  "reporters","contact_lang","",		"Reporter Language",""),
	array ("reporter_location_id","",	"1","2","","",  "reporters","contact_location_id","",	"Reporter Location ID","",   "category","level","reporter_location_id_"),
	array ("reporter_location","",		"1","2","","",  "reporters","contact_location","",	"Reporter Location",""),
	array ("reporter_location_id_0","",	"1","2","","",  "reporters","contact_location_id_0","",	"Reporter Region ID",""),
	array ("reporter_location_id_1","",	"1","2","","",  "reporters","contact_location_id_1","",	"Reporter District ID",""),
	array ("reporter_location_id_2","",	"1","2","","",  "reporters","contact_location_id_2","",	"Reporter County ID",""),
	array ("reporter_location_id_3","",	"1","2","","",  "reporters","contact_location_id_3","",	"Reporter Sub County ID",""),
	array ("reporter_location_id_4","",	"1","2","","",  "reporters","contact_location_id_4","",	"Reporter Parish ID",""),
	array ("reporter_location_id_5","",	"1","2","","",  "reporters","contact_location_id_5","",	"Reporter Village ID",""),
	array ("reporter_location_0","",	"1","2","","",  "reporters","contact_location_0","",	"Reporter Region",""),
	array ("reporter_location_1","",	"1","2","","",  "reporters","contact_location_1","",	"Reporter District",""),
	array ("reporter_location_2","",	"1","2","","",  "reporters","contact_location_2","",	"Reporter County",""),
	array ("reporter_location_3","",	"1","2","","",  "reporters","contact_location_3","",	"Reporter Sub County",""),
	array ("reporter_location_4","",	"1","2","","",  "reporters","contact_location_4","",	"Reporter Parish",""),
	array ("reporter_location_5","",	"1","2","","",  "reporters","contact_location_5","",	"Reporter Village",""),

	array ("client_count","",		"3","4","v","",  "","","",	"Client Count",""), // validate using externa hook
	array ("perp_count","",			"3","4","v","",  "","","",	"Perpetrator Count",""), // validate using externa hook
...
$messages_api = array
(	
	array ("pmessages","","dup","src","src","src_uid","src_uid", NULL,"id"), // link to first message
	array ("pmessages","",""),
	array ("messages","",""),
	array ("pmessages","messages","agg4", "id","pmsg_id", NULL, "pmsg_id","pmsg_id"),
...
$reporters_uuid_api = array // create reporter from contact_id and generate uuid
(
...
$reporters_api = array // update reporter (create only at reporter_uuid)
(	
	array ("reporters","","aub"),
	array ("reporters","","dup","id","reporter_id", NULL, "contact_id:contact_id:s"), // set contact_id (if not given)
	array ("contacts","","include"),
	array ("contacts","_dup","include"),
	array ("cases","","dup","id","case_id",NULL, "id", "reporter_id:case_reporter_id"),
	array ("reporters","",""),
	array ("cases","reporters","agg1", "reporter_id","reporter_id",NULL,  "id","reporter_id"), // update case with reporter (only works for 1st reporter)
...
(
	...
	array ("users","","duf","id","escalated_to_id",NULL, "id:escalated_to_id", "usn:escalated_to", "role:escalated_to_role", "exten:escalated_to_exten"),
	array ("users","","params", "_escalated_by_id_","::escalated_to_id: 0:auth_id"),
	array ("users","","dup","id","_escalated_by_id_",NULL, "id:escalated_by_id", "usn:escalated_by", "role:escalated_by_role"),
	array ("users","","dup","id","escalated_to_id",NULL, "id:assigned_to_id"), // override created_by
	...
	array ("reporters","","params", "reporter_id","reporter_uuid_id"), // update case_id during case create only
	array ("reporters","_dup","include"),

	array ("cases","","aub"),
	array ("cases","",""), 
	array ("reporters","","","1",""),			// update case_id during case create only 
...
(
	array ("activities","","params", 		"src_uid2","::src_uid2: null:src_uid2"), // ensure src_uid2 is not blank;
	array ("activities","","dup", 			"src","src","src_uid","src_uid",NULL, "id:activity_id", "src_uid2:src_uid2"), // get src_uid2 (if exists)

	array ("actions","","params", 			"action"," disposition", "src_uid_","src_uid", "src_uid2_","src_uid2", "is_active"," 1", "has_contact","::reporter_id: 0: 1"),
	array ("actions","",""),
	array ("dispositions","",""),
	array ("dispositions","dispositions","agg1", 	"src","src","src_uid","src_uid", "case_id"," 0", NULL, "src","src","src_uid","src_uid", "case_id",":>: 0"), // unlink non-case

	array ("activities","dispositions","agg4",	"id","activity_id", 	NULL, "src","src","src_uid_","src_uid"),	// update activity (if exists)	
	array ("calls","dispositions","agg4",	  	"uniqueid","src_uid2", 	NULL, "src","src","src_uid2_","src_uid2"),	// update call (if exists)
);
...
["messages","","100",	"src","src","src_uid","src_uid"], 
];
