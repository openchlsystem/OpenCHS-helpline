...
function usummary (el, _u, _a, _r, _m)
{
	...
	lbl = "Total";
        ...
        nd (el, te["rpt_sum"], [m[10], v, lbl,"#000000","c mr mb"], [], [5]);
...
function pivot_sort_list_x (u, xx, rrx)
{
	 var ri = [];
        ...
        while (i>-1)
        {
                // console.log ("rx("+i+") "+_i); // " "+j[_i][0]+" "+rx[_i].k[ j[_i][0] ] )
        ...
        // console.log ("rxv "+i+"  "+j[_i][0]+" , "+j[_i][1])
                        ...
                        // console.log ("rx do ("+i+" of "+xn+") "+_i+" "+j[_i][0]+" "+rx[_i].k[ j[_i][0] ]+" | "+xx[_i]+":"+rk_ )

			if (i==xn) // update index
                        {
				console.log ("rx[i]"+i+"|"+rx[_i].k[j[_i][0]]+"|"+JSON.stringify(rx[i]))
                ...
                if  (rx[i] && rx[i].k.length>0) // descend
                {
                        ...
                        // console.log ("rx descend ("+i+") "+_i+" "+j[_i][0]+" "+rx[_i].k[ j[_i][0] ] )
                        continue;
                }
...
function rpt (el)
{
	...
	console.log ("rpt ("+el.id+")=>"+JSON.stringify (a))
