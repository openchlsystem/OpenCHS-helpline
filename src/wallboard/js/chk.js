...
te["taga"] = { div:["c","va"], s:["mtag gb cw bd_",""], c: // .f.f.f
[
...
[
	{ div:["d w02_"], ac:["abs w02_ ao",null,"_usel","x y04 cs bdr_ tc","&Cross;"] },
	{ div:["x y04 mr3"], uval:["",null] },
...
te["tagf"] = { div:["c ml mt gg cw bd_","va"], c:
[
	{ div:["c x07 y"], uval:["",null] },
	{ ac:["c l ao","","_uchkf","x y n cws","&Cross;"] },
...
te["f"] = { div:["c"], c: // 
[
	{ div:["c t"], s:["x y cb",null] }, 
	{ ac:["c l t","","_uchkp","x y cb","&Cross;"] },
