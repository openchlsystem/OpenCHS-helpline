...
rk["case_cases_k"] = [ "cat_0", "cat_1", "cat_2", "cat_3", "cat_4", "gbv_related", "source", "priority", "status", "created_by", "escalated_to", "escalated_by", "assessment", "justice"];
rk["case_reporters_k"] = ["reporter_age_group", "reporter_sex", "reporter_tribe", "reporter_lang", "reporter_location_0", "reporter_location_1", "reporter_location_2", "reporter_location_3", "reporter_location_4", "reporter_location_5","reporter_location_6"];
rk["case_clients_k"] = ["clients^contact_age_group", "clients^contact_sex", "clients^contact_tribe", "clients^contact_lang", "clients^contact_location_0", "clients^contact_location_1", "clients^contact_location_2", "clients^contact_location_3", "clients^contact_location_4","clients^contact_location_5","clients^contact_location_6","clients^relationship","clients^disability"];
rk["case_perps_k"] = ["perpetrators^contact_age_group", "perpetrators^contact_sex", "perpetrators^contact_tribe", "perpetrators^contact_lang", "perpetrators^contact_location_0", "perpetrators^contact_location_1", "perpetrators^contact_location_2", "perpetrators^contact_location_3", "perpetrators^contact_location_4", "perpetrators^contact_location_5", "perpetrators^contact_location_6", "perpetrators^relationship"];
...
re["case_k"] = 
{
	...
	"reporter_location_6":["reporter_location_6","Reporter Constituenct"],
...
[
	...
	[
		...
		[
			...
			{ div:["dd w20 y ba gw sh","vdd"], ev:["_undd"], case_rpt_menu:[] }	
		]},
		{ div:["d"], s:["",""], c:
		[
			{ div:["d"], c: // xaxis
...
[
	...
	{ ac:["c rg rc r ay bd_","","_opt","x cb",""], c:
	[
		{ div:["c w01_ t"], s:["opt",""] },
		{ s:["c x y wm05",null] },
		{ div:["e"] }			
...
[
	...
	{ div:["",null], c:
	[
		{ li:["gws","va"], c:[ { div:["",null], ev:["_dd"], c: // ls
		[
...
[
        ...
        { div:["",null], c:
        [
                { li:["gws b02","va"], c:[ { div:["",null], ev:["_dd"], c: // ls
                [
                        { p:[null,"o"], c:
                        [ 
                        	{ u:[null,null] }, 
...
[
	...
	{ div:["",null], c:
	[
		{ li:["gws b05","va"], c:[ { div:[], ev:["_dd"], c: // ls
		[
...
[ 
	{ div:[], c:[ { input:[null,null,"","","text",""], ev:["","_ky","","_uky"] } ] }, 
...
[
	{ s:["x y",null] },
	{ p:["gws h03_","o"], c:[ { input:[null,"",null,null,"",""] } ] },
	{ span:["g","",null] }, // input placeholder already in forms
]};

// -----------------------

te["case_household_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","","household_id", HOUSEHOLD_TYPE_ROOT_ID,""] };

te["case_household_enum"] = { case_enum_ls:[null,"tag-r_--o-case_household_tag_txa-%1-household_id-%0-", "category_ls-subcategories", "c w17", "case_household_tag_txa","r_", null,"case_household_tag_txa",null,"household_id",null,"", HOUSEHOLD_TYPE_ROOT_ID, "noop","dd w21 gw ba_b", "noop"] };

// ---

te["case_guardian_marital_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","","guardian_marital_id", MARITAL_STATUS_ROOT_ID,""] };

te["case_guardian_marital_enum"] = { case_enum_ls:[null,"tag-r_--o-case_guardian_marital_tag_txa-%1-guardian_marital_id-%0-", "category_ls-subcategories", "c w17", "case_guardian_marital_tag_txa","r_", null,"guardian_marital_id",null,"guardian_marital_id",null,"", MARITAL_STATUS_ROOT_ID, "noop","dd w21 gw ba_b", "noop"] };

// ---

te["case_household_head_employment_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","Select Employment Status","household_head_occupation_id", EMPLOYMENT_STATUS_ROOT_ID,""] };

te["case_household_head_employment_enum"] = { case_enum_ls:[null,"tag-r_--o-case_household_head_employment_tag_txa-%1-household_head_occupation_id-%0-", "category_ls-subcategories", "c w17", "case_household_head_employment_tag_txa","r_", null,"case_household_head_employment_tag_txa",null,"household_head_occupation_id",null,"", EMPLOYMENT_STATUS_ROOT_ID, "noop","dd w20 gw ba_b", "noop"] };

// ---

te["case_spouse_employment_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","Select Employment Status","spouse_profession_id", EMPLOYMENT_STATUS_ROOT_ID,""] };

te["case_spouse_employment_enum"] = { case_enum_ls:[null,"tag-r_--o-case_spouse_employment_tag_txa-%1-spouse_profession_id-%0-", "category_ls-subcategories", "c w17", "case_spouse_employment_tag_txa","r_", null,"case_spouse_employment_tag_txa",null,"spouse_profession_id",null,"", EMPLOYMENT_STATUS_ROOT_ID, "noop","dd w21 gw ba_b", "noop"] };

// ---

te["case_hiv_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w20 xx tt b05","fullname_","","hiv_id", HIV_STATUS_ROOT_ID,""] };

te["case_hiv_enum"] = { case_enum_ls:[null,"tag-r_--o-case_hiv_tag_txa-%1-hiv_id-%0-", "category_ls-subcategories", "c w17", "case_hiv_tag_txa","r_", null,"case_hiv_tag_txa",null,"hiv_id",null,"", HIV_STATUS_ROOT_ID, "noop","dd w20 gw ba_b", "noop"] };

// ---

te["case_disability_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w20 xx tt b05","fullname_","","disability_id", DISABILITY_ROOT_ID,""] };

te["case_disability_enum"] = { case_enum_ls:[null,"tag-r_--o-case_disability_tag_txa-%1-disability_id-%0-", "category_ls-subcategories", "c w17", "case_disability_tag_txa","r_", null, "case_disability_tag_txa",null,"disability_id",null,"", DISABILITY_ROOT_ID, "noop","dd w20 gw ba_b", "noop"] };

// ---

te["case_school_level_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w20 xx tt b05","fullname_","","school_level_id", SCHOOL_LEVEL_ROOT_ID,""] };

te["case_school_level_enum"] = { case_enum_ls:[null,"tag-r_--o-case_school_level_tag_txa-%1-school_level_id-%0-", "category_ls-subcategories", "c w17", "case_school_level_tag_txa","r_",null, "case_school_level_tag_txa",null,"school_level_id",null,"", SCHOOL_LEVEL_ROOT_ID, "noop","dd w20 gw ba_b", "noop"] };

// --- 

te["case_school_type_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w20 xx tt b05","fullname_","","school_type_id",SCHOOL_TYPE_ROOT_ID,""] };

te["case_school_type_enum"] = { case_enum_ls:[null,"tag-r_--o-case_school_type_tag_txa-%1-school_type_id-%0-", "category_ls-subcategories", "c w17", "case_school_type_tag_txa","r_", null, "case_school_type_tag_txa",null,"school_type_id",null,"", SCHOOL_TYPE_ROOT_ID, "noop","dd w20 gw ba_b", "noop"] };

// ---

te["case_employment_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","Select Work Status","employment_id", EMPLOYMENT_STATUS_ROOT_ID,""] };

te["case_employment_enum"] = { case_enum_ls:[null,"tag-r_--o-case_employment_tag_txa-%1-employment_id-%0-", "category_ls-subcategories", "c w18", "case_employment_tag_txa","r_", null, "case_employment_tag_txa",null,"employment_id",null,"", EMPLOYMENT_STATUS_ROOT_ID, "noop","dd w21 gw ba_b", "noop"] };

// --- 

te["case_health_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","Select Health Status","health_id",HEALTH_STATUS_ROOT_ID,""] };

te["case_health_enum"] = { case_enum_ls:[null,"tag-r_--o-case_health_tag_txa-%1-health_id-%0-", "category_ls-subcategories", "c w17", "case_health_tag_txa","r_", null, "case_health_tag_txa",null,"health_id",null,"", HEALTH_STATUS_ROOT_ID, "noop", "dd w21 gw ba_b", "noop"] };

// ---

te["case_shareshome_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w20 xx tt b05","fullname_","","shareshome_id",SHARES_HOME_ROOT_ID,""] };

te["case_shareshome_enum"] = { case_enum_ls:[null,"tag-r_--o-case_shareshome_tag_txa-%1-shareshome_id-%0-", "category_ls-subcategories","c w17", "case_shareshome_tag_txa","r_", 
null, "case_shareshome_tag_txa",null,"shareshome_id",null,"", SHARES_HOME_ROOT_ID, "noop","dd w20 gw ba_b", "noop"] };

// ---

te["case_rela_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w20 xx tt b05","fullname_","Select Relationship","relationship_id",RELATIONSHIP_ROOT_ID,""] };

te["case_rela_enum"] = { case_enum_ls:[null,"tag-r_--o-case_rela_tag_txa-%1-relationship_id-%0-", "category_ls-subcategories", "c w17", "case_rela_tag_txa","r_", null, "case_rela_tag_txa",null, "relationship_id",null,"",  RELATIONSHIP_ROOT_ID, "noop", "dd w20 gw ba_b", "noop"] };

// ---

te["case_not_in_school_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w62 xx tt b05","fullname_","Select Reason","not_in_school_id",NOT_IN_SCHOOL_ROOT_ID,""] };

te["case_not_in_school_enum"] = { case_enum_ls:[null,"tag-r_--o-case_not_in_school_tag_txa-%1-not_in_school_id-%0-", "category_ls-subcategories", "c w59", "case_not_in_school_tag_txa","r_", null, "case_not_in_school_tag_txa",null,"not_in_school_id",null,"",  NOT_IN_SCHOOL_ROOT_ID, "noop", "dd w62 gw ba_b", "noop"] };

// ---

te["case_loc_tag_txa"] = { case_enum_tag_txa_:["","w38 xx tt b05","fullname_","Select Location","location_id",LOCATION_ROOT_ID,"1,2,3,4"] };

te["case_loc_enum"] = { case_enum_lsh:["x y",null,"",
"tag-r_--o-case_loc_tag_txa-%1-location_id-%0-",   "category_ls-subcategories", "c w38", 
"case_loc_tag_txa","r_", 
null, "case_loc_tag_txa",null,"location_id",null,"",   
"category_lsh_root-subcategories", LOCATION_ROOT_ID, 
"dd w65 gw ba_b", "noop"] };

// ---

te["case_lang_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","Select Language","lang_id",LANGUAGE_ROOT_ID,""] };

te["case_lang_enum"] = { case_enum_ls:[null,"tag-r_--o-case_lang_tag_txa-%1-lang_id-%0-", "category_ls-subcategories", "c w18", "case_lang_tag_txa","r_", null, "case_lang_tag_txa", null, "lang_id", null,"", LANGUAGE_ROOT_ID, "noop", "dd w21 gw ba_b", "noop"] };

// ---

te["case_tribe_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","Select Tribe","tribe_id",TRIBE_ROOT_ID,""] };

te["case_tribe_enum"] = { case_enum_ls:[null,"tag-r_--o-case_tribe_tag_txa-%1-tribe_id-%0-", "category_ls-subcategories", "c w17", "case_tribe_tag_txa","r_", null, "case_tribe_tag_txa",null, "tribe_id",null,"",  TRIBE_ROOT_ID, "noop", "dd w21 gw ba_b", "noop"] };

// ---

te["case_nationality_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","Select Nationality","nationality_id", NATIONALITY_ROOT_ID,""] };

te["case_nationality_enum"] = { case_enum_ls:[null,"tag-r_--o-case_nationality_tag_txa-%1-nationality_id-%0-", "category_ls-subcategories", "c w17", "case_nationality_tag_txa","r_", null, "case_nationality_tag_txa",null,"nationality_id",null,"", NATIONALITY_ROOT_ID, "noop", "dd w21 gw ba_b", "noop"] };

// ---

te["case_national_id_type_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","Select ID Type", "national_id_type_id", NATIONAL_ID_TYPE_ROOT_ID,""] };

te["case_national_id_type_enum"] = { case_enum_ls:[null,"tag-r_--o-case_national_id_type_tag_txa-%1-national_id_type_id-%0-", "category_ls-subcategories", "c w17", "case_national_id_type_tag_txa","r_", null, "case_national_id_type_tag_txa",null,"national_id_type_id",null,"",  NATIONAL_ID_TYPE_ROOT_ID, "noop", "dd w21 gw ba_b", "noop"] };

// ---

te["case_sex_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","Select Gender","sex_id",SEX_ROOT_ID,""] };

te["case_sex_enum"] = { case_enum_ls:[null,"tag-r_--o-case_sex_tag_txa-%1-sex_id-%0-", "category_ls-subcategories", "c w18", "case_sex_tag_txa","r_", null, "case_sex_tag_txa",null,"sex_id",null,"",  SEX_ROOT_ID, "noop", "dd w21 gw ba_b", "noop"] };

// ---

te["case_age_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w21 xx tt b05","fullname_","Select Age","age_group_id",AGE_GROUP_ROOT_ID,""] };

te["case_age_enum"] = { case_enum_ls:[null,"tag-r_--o-case_age_tag_txa-%1-age_group_id-%0-", "category_ls-subcategories", "c w18", "case_age_tag_txa","r_", null, "case_age_tag_txa",null, "age_group_id",null,"",   AGE_GROUP_ROOT_ID, "noop", "dd w21 gw ba_b", "noop"] };

// ----

te["case_referal_sel_sub"] = { div:["","sub"], c:
[
	// 362009:Others referal
	{ arg:["case_ed_sub_other_referal-r_-_case_referals_-_case_other_referal_","","362009"] },
]};

te["case_referal_enum"] = { case_enum_lc:[null,"taga-r_--a--%1-category_id-%0-%2", "case_referal_lc_main-subcategories", "referals", "c w34 x y",    
null,"referal_del-referals-case_id"," %1","category_id"," %0","%2",  
CASE_REFERALS_ROOT_ID,"noop", 
"dd w40 ba_b gw","case_referal_sel_sub"] };

// ---

te["case_service_sel_sub"] = { div:["","sub"], c:
[
	{ arg:["case_ed_sub_referals-r_-ve-_case_referals_","","385462"] },
	//{ arg:["case_ed_sub_police_ref-r_-ve-_case_police_ref_","","362036"] },
	//{ arg:["case_ed_sub_other_service-r_-ve-_case_other_service_","","362042"] },
]};

te["case_service_enum"] = { case_enum_lc:[null,"taga-r_--a--%1-category_id-%0-%2", "case_service_lc_main-subcategories", "services", "c w35 x y",    
null, "service_del-services-case_id"," %1","category_id"," %0"," %2",  
CASE_SERVICES_ROOT_ID,"noop", 
"dd w40 ba_b gw","case_service_sel_sub"] };

// ---

te["case_knowabout116_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w37 xx tt b05","fullname_","","knowabout116_id",CASE_KNOW_ABOUT_116_ROOT_ID,""] };

te["case_knowabout116_enum"] = { case_enum_ls:[null,"tag-r_--o-case_knowabout116_tag_txa-%1-knowabout116_id-%0-", "category_ls-subcategories", "c w37", "case_knowabout116_tag_txa","r_", null,"case_knowabout116_tag_txa",null,"knowabout116_id",null,"", CASE_KNOW_ABOUT_116_ROOT_ID, "noop", "dd w40 gw ba_b", "noop"] };

// ---

te["case_justice_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w30 xx tt b05","fullname_","","justice_id",CASE_JUSTICE_ROOT_ID,""] };

te["case_justice_enum"] = { case_enum_ls:[null,"tag-r_--o-case_justice_tag_txa-%1-justice_id-%0-", "category_ls-subcategories", "c w19", "case_justice_tag_txa","r_", null,"case_justice_tag_txa",null,"justice_id",null,"", CASE_JUSTICE_ROOT_ID, "noop", "dd w30 gw ba_b", "noop"] };

// ---

te["case_assessment_tag_txa"] = { case_enum_tag_txa_:["category_ls-subcategories","w30 xx tt b05","fullname_","","assessment_id",CASE_ASSESSMENT_ROOT_ID,""] };

te["case_assessment_enum"] = { case_enum_ls:[null,"tag-r_--o-case_assessment_tag_txa-%1-assessment_id-%0-", "category_ls-subcategories", "c w19", "case_assessment_tag_txa","r_", null,"case_assessment_tag_txa",null,"assessment_id",null,"", CASE_ASSESSMENT_ROOT_ID, "noop", "dd w30 gw ba_b", "noop"] };
...
[ 
	{ div:[], c:[ { input:["w37 xx tt b05","usn_","","","text",""], ev:["","_ky","","_uky"] } ] }, 
	// { input:["w37 xx tt b05","usn_","","","text",""], ev:["","_ky","","_uky"] }, 
	// { arg:["","escalated_to_id",""] }, // placeholder for upd -- disable
	{ case_escalated_to_args:[] }
]} ]};

te["case_escalated_to_enum"] = { case_enum_ls:[null,"tag-r_--o-case_escalated_to_tag_txa-%1-escalated_to_id-%0-", "user_ls-users", "c w17", "case_escalated_to_tag_txa","r_", null,"case_escalated_to_tag_txa",null,"escalated_to_id",null,"",  "", "case_escalated_to_args", 
"dd w29 gw ba_b", "noop"] };
...
te["case_priority_enum"] = { case_enum_sel:[null,null,null, "tag-r_--o--::case_priority:0:1-priority-%0-", "c w16",  null," ::case_priority:0:1","priority"," %0","", 
"dd w20 ba_b gw cb","case_priority_r","case_priority"] };
...
te["case_status_enum"] = { case_enum_sel:[null,null,null, "tag-r_--o--::case_status:0:1-status-%0-", "c w16",  null," ::case_status:0:1","status"," %0","", 
"dd w20 ba_b gw cb","case_status_r","case_status"] };

// ---

te["case_category_sel_sub"] = { div:["","sub"], c:
[
	// 87:abuse, 362263:physical violence, 362271:sexual violence
	{ arg:["case_ed_sub_medical_exam,case_ed_sub_medical_exam-r_-ve-_case_medical_exam_","","362263,362271"] },
	{ arg:["case_ed_sub_incidence-r_-ve-_case_incidence_","","362271"] },
	{ arg:["case_ed_sub_justice-r_-ve-_case_justice_","","385350"] },
]};

te["case_category_tag_txa"] = { case_enum_tag_txa_:["","w75 xx tt b05","fullname_","Select Category","case_category_id",CASE_CATEGORY_ROOT_ID,"1,2,3,4,5"] };

te["case_category_enum"] = { case_enum_lsh:["x y","Case Category","*",
"tag-r_--o-case_category_tag_txa-%1-case_category_id-%0-%2", "category_ls-subcategories", "c w65", 
...
"category_lsh_root-subcategories",CASE_CATEGORY_ROOT_ID, 
"dd w70 gw ba_b","case_category_sel_sub"] };
...
[
	...
	{ p:["","_case_other_referal_"], usub:["case_ed_sub_other_referal","r_",":v:cases:referals","362009"] },
]};

// ---

te["case_ed_sub_incidence_counseling_loc"] = { case_txt_:["Which organisation was s/he referred to?","gws w30 x tt b05","counseling_org",":v:cases:counseling_org",""] };
...
te["case_ed_sub_incidence"] = { div:["xx w75_ ba_ mt15"], c:
[
...
te["case_ed_sub_medical_exam"] = { div:["xx w75_ ba_ mt15"], c:
[
	{ arg:["","","case_ed_sub_medical_exam"] },
	{ div:["yy"], c:
	[
...
[
	{ div:["c w22 r20"], case_justice_enum:["State in Justice System",":v:cases:justice_id",":v:cases:justice"," %0"] },
	{ div:["c w22 r20"], case_assessment_enum:["Case Assessment",":v:cases:assessment_id",":v:cases:assessment"," %0"] },
	{ div:["e"] }
]};

// ------------------------------------------------------------------------

te["case_update_"] = { div:["w65 ma sh__ gw"], c:
[
	{ div:["xx y08 bb_"], c:
	[
		{ s:["c x y n b","Case Update"] },
		{ ac:["d ay","","_uvp","x y h3 cb","&Cross;"] },
		{ div:["e"] }
	]},
	{ div:["tt x15"], c:
	[
		{ s:["c x y h3 b",CASE_ID_PREFIX] },
		{ s:["c x y h3 b","%0"] },		
		{ div:["e"] }
	]},
	{ div:["","ve"], s:["t x15",""], c:
	[
		...
		[
			{ s:["x y","Case Action"] },
			{ p:["","o"], c:[ { textarea:["gws bd w62 h11 xx y08","","plan","","Enter Case Action"] } ] } // :v:cases:plan
		]},
		
		{ div:[], usub:["case_ed_sub_justice","r_",":v:cases:case_category_fullname_id","385350"] },
		
		{ div:["t15"], c:
		[
			{ div:["c w20 r10"], case_priority_enum:["x y","Priority","*",":v:cases:priority"] },
			{ div:["c w20 r10"], case_status_enum:["x y","Status","*",":v:cases:status"] },
			{ div:["c w20"], case_escalated_to_enum:["Escalated To",":v:cases:escalated_to_id",":v:cases:escalated_to"," %0"] },
			{ div:["e"] }
		]},
		...
		[	
			{ div:["d"], c:
			[
				{ ac:["btn w20 t30 b05 ao",null,"_postj_case_update","y gb cw tc","Update"] },
			...
			[ 
				{ arg:["",".id","%0"] }, 
				{ arg:["","case_id","%0"] },
				{ arg:["","disposition_id",DISPOSITION_ID_FOLLOWUP] }, // default to completed
			] },
			{ div:["e"] }
		]}
	]}
...
te["followup_update"] = { case_update_:["followup_update-cases"] };
...
[
	{ div:[], c:
	[
		{ div:["c w70 r15"], case_category_enum:[] },
		{ div:["c g"], c:
		[
			{ div:[], c:
			[
				{ s:["c x y","Is Case GBV Related?"] },
				{ s:["c t cr b h2","*"] },
				{ div:["e"] }
			]},
			{ p:["","o"], c:
	...
	//{ p:["","_case_medical_exam_"], usub:["case_ed_sub_medical_exam,case_ed_sub_medical_exam","r_",":v:cases:case_category_fullname_id","362263,362271"] },	
	//{ p:["","_case_incidence_"], usub:["case_ed_sub_incidence","r_",":v:cases:case_category_fullname_id","362271"] },
	...
	[
		...
		{ p:["","o"], c:[ { textarea:["gws w70 h24 xx y08","","narrative",":v:cases:narrative","What Really Happened?"] } ] }
	]},
	...
	[
		...
		{ p:["","o"], c:[ { textarea:["gws w70 h13 xx y08","","plan",":v:cases:plan","Enter Case Action"] } ] }
	]},
	
	{ p:["y02","_case_justice_"], usub:["case_ed_sub_justice","r_",":v:cases:case_category_fullname_id","385350"] },
	
	{ div:["t15 b30"], c:
	[
		{ div:["c w22 r20"], case_priority_enum:["x y","Priority","*",":v:cases:priority"] },
		{ div:["c w22 r20"], case_status_enum:["x y","Status","*",":v:cases:status"] },
...
[
	{ u:[null] }, // show repoter for followup/edit
	{ div:[], c:
	[
		{ s:["x y","Is the Reporter a Client?"] },
		{ div:["b05"], c:
		[
			{ input:["g","","is_reporter_client","1","checkbox",":v:cases:is_reporter_client::reporter_is_client:6"] },
			{ ac:["c ay r","","_post_reporter_is_client","h01_ x y cb",""], c:
			[
				{ div:["w01_"], s:["chk",""] },
			]},
			{ div:["e"], s:["",""] }
	...
	{ p:["t15","clients"], c:
	[
		{ case_vw_client:[] }, // client details
		{ div:[], c:
		[
			{ div:["c"], c:
			[
				{ ac:["ay x02","case_client_new-r_-^","_vp","bd16",""], c:
				[ 
					{ s:["c x y h01_ w01_ tc b n gws bd16 cb","+"] }, 
					{ s:["c xx y","Add a Client"] }, 
	...
	[
		{ case_vw_perpetrator:[] }, // perp details
		{ div:[], c:
		[	
			{ div:["c"], c:
			[
				{ ac:["ay x02","case_perpetrator_new-r_-^","_vp","bd16",""], c:
				[ 
					{ s:["c x y h01_ w01_ tc b n gws bd16 cb","+"] }, 
					{ s:["c xx y","Add a Perpetrator"] }, 
					{ div:["e"], c:[ { arg:["case_id-6","","%0"] } ] } 
				]},
	...
	[
		...
		[
			{ div:["c"], c:
			[
				{ ac:["ay x02","case_attachment_upload--attachments-a","_file_dialog","bd16",""], c:
				[ 
					{ s:["c x y h01_ w01_ tc b n gws bd16 cb","+"] }, 
	...
	[ 
		...
		{ p:["bl2_b","_case_referals_"], usub:["case_ed_sub_referals","r_",":v:cases:services","385462"] },
		//{ p:["bl2_b","_case_police_ref_"], usub:["case_ed_sub_police_ref","r_",":v:cases:services","362036"] },
		//{ p:["bl2_b","_case_other_service_"], usub:["case_ed_sub_other_service","r_",":v:cases:services","362042"] },
	]},
...
te["case_form_"] = { div:["","ve"], s:["yy gw",""], c: // new case // div:[" y15 gw"], 
[		
	{ div:["x15 t","va"], c:
	[
		{ div:["c x08 y02"], ac:["","","_uvw","h3 x y bd16 gws micon cb","arrow_back"] }, // { u:[null] },	
		{ s:["c x08 yy h2 b",CASE_ID_PREFIX] },
		{ s:["c tt h2 b w40",null] },
		{ u:[null] },
		{ div:["e"] }
	]},
	
	{ div:["x15 t"], c:[ { p:["c w100","nb"], c:[ { u:["nb","cases_nb"] }, { u:["nb","newcase_nb"] } ] }, { div:["e"] } ] },
					
	{ div:["x15 w120_"], c:
	[
		{ div:["c w40 l r40 t03"], case_form_col_0:[null] },
		{ div:["d w75_"], case_form_col_1:[] },
		{ div:["e"] }
	]},
	...
	[
		...
		// { div:["c xx","va"], ac:["w12 ao","","","y04 tc cd ba","Disposition"], c:[ { arg:["",".id","%0"] } ] }, // todo: on cancel notify that changes will be

		{ div:["d w12 ll"], c:
		[
			{ ac:["btn ao",null,"_postj_case","y tc gb b cw",null] },
			{ div:["savl"], s:["yy tc bd go b n cw","Saving..."] }
		]},

		{ div:["d xx","va"], ac:["w12 ao",null,null,"y04 tc cd ba","Cancel"], c:[ { arg:["",".id","%0"] } ] }, // todo: on cancel notify that changes will be lost	
		{ p:["e","o"], c:
		[
			{ arg:["","disposition_id",null] }, // default to completed
			{ arg:["",".id","%0"] }
		]},
...
te["case_ed"] = { case_form_:["%0","noop","case_vw_reporter",  		"case_form-cases","Update","case_vw_id-cases-vw","_u",DISPOSITION_ID_COMPLETE] };

te["case_new"] = { case_form_:["NEW CASE","noop","noop", 		"case_form-cases","Create","","_uvw",DISPOSITION_ID_COMPLETE] };
...
[
	{ div:["c w37","va"], ac:["ay","files","_file_download","x cb",""], c:
	[
		{ s:["c w28 x y",null] },
		{ s:["d w06 x y s tr",null] }, 
		{ div:["e"], c:[ { arg:["",".id",null] }, { arg:["","file","1"] } ] }
	]},
	{ arg:["","is_delete","1"] },
	{ arg:["o",null,null] },
	{ ac:["d ay ve_",null,null,"x07 y tc n bdr ","&Cross;"] },
...
[
	{ li:["gws mb bd","perpetrator_vw_id-perpetrators-^"], ev:["_vp"], s:["",""], c:
	[
		{ div:[], c:
		[
			{ div:["d w03"], s:["abs w02_ x",""], c:
			[
				{ arg:["","is_delete","1"] },
				{ arg:["",".id","%0"] },
				{ ac:["ay ve_ x03 y03","perpetrator_del-perpetrators","_del","x04 y02 n","&Cross;"] },
			]},
			{ div:["e"] }
		]},
		{ div:["mr3"], c:
		...
		{ div:["mr3"], c:
		[
			{ div:["xx y"], uval:["",":v:perpetrators:contact_location"] },
		]}
	]},
...
[
	{ div:[""], c:
	[
		{ s:["c x y cb ","Perpetrator Details"] },
		{ div:["e"] }
	]},
...
te["case_vw_client_r_"] = {  c: // 
[
	{ li:["gws bd mb","client_vw_id-clients-^"], ev:["_vp"], s:["",""], c:
	[
		{ div:[], c:
		[
			{ div:["d w03"], s:["abs w02_ x",""], c:
			[
				...
				{ ac:["ay ve_ x03 y03","client_del-clients","_del","x04 y02 n","&Cross;"] },
			]},
			{ div:["e"] }
		]},
		{ div:["mr3 gval"], c:
		...
		{ div:["mr3 gval"], c:
		[
			{ div:["xx t"], uval:["",":v:clients:contact_location"] },
			{ div:["x y w08"], s:[":v:clients:is_reporter::reporter_is_client:4",":v:clients:is_reporter::reporter_is_client:5"] }, 
		]}
	]},
...
te["case_vw_client_r"] = { div:["","va"], case_vw_client_r_:[] };

te["case_vw_client"] = { c:
[
	{ div:["t02"], c:
	[
		{ s:["c x y cb n","Client Details"] },
...
[
	{ li:["gws bd","reporter_vw_id-reporters-^"], ev:["_vp"], s:["",""], c:
	[
		{ div:["t mr3"], c:
		[
			{ s:["c xx t n",":v:reporters:contact_fullname"] },
			{ div:["d xx t n"], uval:["",":v:reporters:contact_age"] },
			{ div:["d t n"], uval:["",":v:reporters:contact_sex"] },
			{ div:["e"], arg:["",".id","%0"] },
		]},
		{ div:["mr3"], c:
		[
			{ div:["xx y"], uval:["",":v:reporters:contact_location"] },
		]}
	]},
...
[
	{ div:[], c:
	[
		{ s:["c x y cb","Reporter Details"] },
		{ div:["e"] }
	]},
	{ p:["b05","a"], u:["case_vw_reporter_r","reporters"] },
]};
...
[
	...
	{ div:[], usub:["case_vw_sub_other_referal","r_",":v:cases:referals","362009"] },
]};

te["case_vw_sub_justice"] = { div:["tt"], c:
[
	{ div:["c w50"], case_vw_val_cat:["Status in Justice System","",":v:cases:justice"] },
	{ div:["c w20"], case_vw_val_cat:["Case Assessment","",":v:cases:assessment"] },
	{ div:["e"] }
]};
...
[
	...
	[
		{ div:[], c:
		[			
			{ div:["c w49 r10"], case_vw_val_cat:["Case Category","",":v:cases:case_category"] },
	//		{ div:["c w24"], case_vw_val:["Is Case GBV Related?",":v:cases:gbv_related::yesno:2"] },
			{ div:["e"] }
		]},
		//{ div:[], usub:["case_vw_sub_medical_exam,case_vw_sub_medical_exam","r_",":v:cases:case_category_fullname_id","362263,362271"] },
		//{ div:[], usub:["case_vw_sub_incidence","r_",":v:cases:case_category_fullname_id","362271"] },	
	]},
	{ div:["tt"], c:
	[
	...
	{ div:["tt"], c:
	[
		{ s:["x tt v","Case Action"] },
		{ pre:["x y n mh02 bd w60","",":v:cases:plan"] }
	]},
	
	//{ div:[], usub:["case_vw_sub_justice","r_",":v:cases:case_category_fullname_id","87"] },
		
	{ div:["t15"], c:
	[
		{ div:["c w24 r10"], case_vw_val:["Priority",":v:cases:priority::case_priority:1"] }, 
		{ div:["c w24 r10"], case_vw_val:["Status",":v:cases:status::case_status:1"] }, 
		{ div:["c w24"],  case_vw_val:["Escalated To",":v:cases:escalated_to"] },
		{ div:["e"] }
	]},
]};
...
[
	...
	{ div:["tt"], case_vw_client:[] },
	
	{ div:["tt"], case_vw_perpetrator:[] },

	{ div:["tt"], case_attachments:[] },
	
	{ div:["tt"], c:
	[
		{ s:["x tt","Services Offered"] },
		{ div:["r05 b05 n"], c:
		[ 
			{ uchk:["tagv",":v:cases:services","","",  "x y bd gws mr"," %1"] }, 
			{ div:["e"] } 
		]},
		// { div:["bl2_b"], usub:["case_vw_sub_referals","r_",":v:cases:services","117"] },
		// { div:["bl2_b"], usub:["case_vw_sub_police_ref","r_",":v:cases:services","362036"] },
		// { div:["bl2_b"], usub:["case_vw_sub_other_service","r_",":v:cases:services","362042"] },

	]},
	
	{ div:["yy"], case_vw_val_cat:["Know About 116","",":v:cases:knowabout116"] }
]};

te["case_vw_id"] = { div:["section-to-print","va"], c: 
[	
	{ div:["x15 t20","vb"], c:
	[
		{ div:["c x"], ac:["","","_uvw","h3 x y bd16 gws micon cb","arrow_back"] }, // { u:[null] },	
		// { s:[null,null] },
		{ s:["c l t h2 b",CASE_ID_PREFIX] },
		{ s:["c x t h2 b","%0"] },

		{ div:["d r05","va"], ac:["","","_print","x08 y04 h02 n ba cb",""], c:
		[ 
		...
		[
			...
			[
				{ div:["c w10","va"], c:
				[
					{ ac:[" br_w","case_update-cases-^","_vp","x08 y04 h02 n ba cb",""], c:
					[ 
						{ s:["c micon h3","edit"] }, { s:["c xx s","Update"] }, { div:["e"], arg:["",".id","%0"] }
					]},
					{ div:["g"], c:[ { arg:["","","activity_end-activities-vfvw-vdispo-@"] } ] } 
				]},	
				{ ac:["c  w03","","_dd","x y04 ba",""], c:[ { div:["h02 w02 awb"] }] },
				{ div:["e"] }
			]},
			{ div:["dd w13 gw ba mt3","vdd"], c:
			[
				{ div:["","va"], ac:["","case_form-cases-vw","_u","xx y cb","Edit"], c:[ { arg:["",".id","%0"] } ] },
			]}
		]},
		{ div:["d r05","va"],  c:
		[ 
			{ input:["g","","case_vw_id_t","1","radio"] },
			{ ac:["ao tab","","_tab","x08 y04 h02 n ba cb",""], c:[ { s:["c micon h3","history"] }, { s:["c xx s","Case History"] }, { div:["e"] } ] }
		]},

		{ div:["d r05","va"], c:
		[ 
			{ input:["g","","case_vw_id_t","0","radio","1"] },
			{ ac:["ao tab","","_tab","x08 y04 ba h02 n cb",""], c:[ { s:["c micon h3","feed"] }, { s:["c xx s","Case Details"] }, { div:["e"] } ] }
		]},
	...
	[
		...
		[
			...
			{ div:["tabv x15 w120_ t b30"], c:
			[
				{ div:["c w40_ r40"], case_vw_col_0:[] },
				{ div:["d ll w75_"], case_vw_col_1:[] },
				{ div:["e"] }
			]}
		]},
...
te["case_disability_root_id"] = { arg:["root_id","",DISABILITY_ROOT_ID] };
te["case_disposition_root_id"] = { arg:["root_id","",DISPOSITION_ROOT_ID] };
te["case_relationship_root_id"] = { arg:["root_id","",RELATIONSHIP_ROOT_ID] };
te["case_justice_root_id"] = { arg:["root_id","",CASE_JUSTICE_ROOT_ID] };
te["case_assessment_root_id"] = { arg:["root_id","",CASE_ASSESSMENT_ROOT_ID] };
te["case_referal_root_id"] = { arg:["root_id","",CASE_REFERALS_ROOT_ID] };
te["case_service_root_id"] = { arg:["root_id","",CASE_SERVICES_ROOT_ID] };
te["case_age_group_root_id"] = { arg:["root_id","",AGE_GROUP_ROOT_ID] };
te["case_sex_root_id"] = { arg:["root_id","",SEX_ROOT_ID] };
te["case_location_root_id"] = { arg:["root_id","",LOCATION_ROOT_ID] };
te["case_category_root_id"] = { c:[ { arg:["root_id","",CASE_CATEGORY_ROOT_ID] }, { arg:["sort","","fullname"] } ] };
...
[
	...
	{ div:["e"], c:[ { arg:["root_id","",CASE_CATEGORY_ROOT_ID] }, { arg:["sort","","fullname"] } ] }
]};

te["case_disability_lc_main"] = { category_lc_main_:["case_disability_root_id"] };
te["case_disposition_lc_main"] = { category_lc_main_:["case_disposition_root_id"] };
te["case_relationship_lc_main"] = { category_lc_main_:["case_relationship_root_id"] };
te["case_justice_lc_main"] = { category_lc_main_:["case_justice_root_id"] };
te["case_assessment_lc_main"] = { category_lc_main_:["case_assessment_root_id"] };
te["case_referal_lc_main"] = { category_lc_main_:["case_referal_root_id"] };
te["case_service_lc_main"] = { category_lc_main_:["case_service_root_id"] };
te["case_age_group_lc_main"] = { category_lc_main_:["case_age_group_root_id"] };
te["case_sex_lc_main"] = { category_lc_main_:["case_sex_root_id"] };
...
[
	...
	{ f:["Status in Justice System",null," %1","justice_id"," %1"] },
...
":k:cases_k:clients^relationship_id:2",":k:cases_k:clients^disability_id:2",
...
":k:cases_f:clients^relationship_id",":k:cases_f:clients^disability_id",
...
[
	{ div:["xx yy"], kf_l:["Referals","tag_-r_--o--%1-category_id-referals^category_id-%0-%1", "case_referal_lc_main-subcategories",
":k:cases_f:referals^category_id", ""," %1","category_id","referals^category_id"," %0"," %1", "case_referal_root_id"] },
]};

te["case_services_f"] = { c:
[
	{ div:["xx yy"], kf_l:["Services","tag_-r_--o--%1-category_id-services^category_id-%0-%1", "case_service_lc_main-subcategories", 
":k:cases_f:services^category_id", ""," %1","category_id","services^category_id"," %0"," %1", "case_service_root_id"] },
]};

te["case_perpetrators_f"] = { c:
[
	{ div:["xx yy"], kf_s:["Perpetrator Name","perpetrators^contact_fullname",":k:cases_f:perpetrators^contact_fullname"] },
	{ div:["xx yy"], kf_s:["Perpetrator Phone","perpetrators^contact_phone",":k:cases_f:perpetrators^contact_phone"] },
	{ div:["xx yy"], kf_l:["Perpetrator Age","tag_-r_--o--%1-category_id-perpetrators^contact_age_group_id-%0-%1", "case_age_group_lc_main-subcategories", 
":k:cases_f:perpetrators^contact_age_group_id", ""," %1","category_id","perpetrators^contact_age_group_id"," %0"," %1", "case_age_group_root_id"] },
	{ div:["xx yy"], kf_l:["Perpetrator Sex","tag_-r_--o--%1-category_id-perpetrators^contact_sex_id-%0-%1", "case_sex_lc_main-subcategories",  
":k:cases_f:perpetrators^contact_sex_id", ""," %1","category_id","perpetrators^contact_sex_id"," %0"," %1", "case_sex_root_id"] },
	{ div:["xx yy"], kf_l:["Perpetrator Location","tag_-r_--o--%1-category_id-perpetrators^contact_location_id-%0-%1", "case_location_lc_main-subcategories",  ":k:cases_f:perpetrators^contact_location_id", ""," %1","category_id","perpetrators^contact_location_id"," %0"," %1", "case_location_root_id"] },
	{ div:["xx yy"], kf_l:["Perpetrator Relationship to Client","tag_-r_--o--%1-category_id-perpetrators^relationship_id-%0-%1", "case_relationship_lc_main-subcategories",  ":k:cases_f:perpetrators^relationship_id", ""," %1","category_id","perpetrators^relationship_id"," %0"," %1", "case_relationship_root_id"] },
]};

te["case_clients_f"] = { c:
[
	{ div:["xx yy"], kf_s:["Client Name","clients^contact_fullname",":k:cases_f:clients^contact_fullname"] },
	{ div:["xx yy"], kf_s:["Client Phone","clients^contact_phone",":k:cases_f:clients^contact_phone"] },
	{ div:["xx yy"], kf_l:["Client Age","tag_-r_--o--%1-category_id-clients^contact_age_group_id-%0-%1", "case_age_group_lc_main-subcategories", 
":k:cases_f:clients^contact_age_group_id", ""," %1","category_id","clients^contact_age_group_id"," %0"," %1", "case_age_group_root_id"] },
	{ div:["xx yy"], kf_l:["Client Sex","tag_-r_--o--%1-category_id-clients^contact_sex_id-%0-%1", "case_sex_lc_main-subcategories",  
":k:cases_f:clients^contact_sex_id", ""," %1","category_id","clients^contact_sex_id"," %0"," %1", "case_sex_root_id"] },
	{ div:["xx yy"], kf_l:["Client Location","tag_-r_--o--%1-category_id-clients^contact_location_id-%0-%1", "case_location_lc_main-subcategories",  ":k:cases_f:clients^contact_location_id", ""," %1","category_id","clients^contact_location_id"," %0"," %1", "case_location_root_id"] },
	{ div:["xx yy"], kf_l:["Reporter Relationship to Client","tag_-r_--o--%1-category_id-clients^relationship_id-%0-%1", "case_relationship_lc_main-subcategories",  ":k:cases_f:clients^relationship_id", ""," %1","category_id","clients^relationship_id"," %0"," %1", "case_relationship_root_id"] },
	
	 { div:["xx yy"], kf_l:["Client Disability","tag_-r_--o--%1-category_id-clients^disability_id-%0-%1", "case_disability_lc_main-subcategories",  ":k:cases_f:clients^disability_id", ""," %1","category_id","clients^disability_id"," %0"," %1", "case_disability_root_id"] },
]};
...
[
	...
	{ div:["xx yy"], kf_l:["Reporter Age","tag_-r_--o--%1-category_id-reporter_age_group_id-%0-%1", "case_age_group_lc_main-subcategories", 
":k:cases_f:reporter_age_group_id", ""," %1","category_id","reporter_age_group_id"," %0"," %1", "case_age_group_root_id"] },
	{ div:["xx yy"], kf_l:["Reporter Sex","tag_-r_--o--%1-category_id-reporter_sex_id-%0-%1", "case_sex_lc_main-subcategories",  
":k:cases_f:reporter_sex_id", ""," %1","category_id","reporter_sex_id"," %0"," %1", "case_sex_root_id"] },
	{ div:["xx yy"], kf_l:["Reporter Location","tag_-r_--o--%1-category_id-reporter_location_id-%0-%1", "case_location_lc_main-subcategories",  ":k:cases_f:reporter_location_id", ""," %1","category_id","reporter_location_id"," %0"," %1", "case_location_root_id"] },
]};
...
""," %1","user_id","escalated_to_id"," %0"," %1", "noop"] },	
	...
	{ div:["xx yy"], kf_l:["Case Assessment","tag_-r_--o--%1-category_id-assessment_id-%0-%1",   "case_assessment_lc_main-subcategories", ":k:cases_f:assessment_id", 
""," %1","category_id","assessment_id"," %0"," %1", "case_assessment_root_id"] },	

	{ div:["xx yy"], kf_l:["Status in Justice System","tag_-r_--o--%1-category_id-justice_id-%0-%1",   "case_justice_lc_main-subcategories", ":k:cases_f:justice_id", 
""," %1","category_id","justice_id"," %0"," %1", "case_justice_root_id"] },	
	
				
]};
	
te["case_f"] = { div:["w55 ma sh__ y gw","vddvf"], ev:["_undd"], c:
[
	{ s:["x20 tt b","Search Case"] },
	{ div:[], c:
	[
		{ div:["xx t15 bb_","vb"], c:
		[
...
te["case_k"] = { div:["w250 bt bb"], s:["",""], c: // activate filter ctx
[
...
[
	...
	[
		...
		{ div:["c l40 ay"], ac:["","cases","_download","x t01 bd_ cb s",""], c:
		[ 
		...
		//	{ div:["e"] }
		// ]},
		{ div:["e"], c:[ { arg:["","","case_list-cases"] }, { arg:["","","0"] }, { arg:["","","-1"] }, { arg:["","",""] } ] }
	]},
	{ div:["y20","vf"], c:[ { li:["ba bd16","case_f-cases_f"], ev:["__vpf"], c:
	[
		{ case_f_tags_k:[] }
	]} ]},
	{ div:[], c:
...
[
	...
	{ div:[], c: // tabs
	[
		{ div:[], c:[ { input:["g","","case_vw_vt","0","radio"] }, { div:["tabv","vftab"] } ] },
		{ div:[], c:[ { input:["g","","case_vw_vt","1","radio"] }, { div:["tabv","vftab"] } ] },
		{ div:[], c:
		[ 
			{ input:["g","","case_vw_vt","2","radio","1"] }, 
			{ form:["tabv"], c:
			[
				{ div:[], c:[ { input:["g","","case_vw_vt_","0","radio","1"] }, { div:["tabv gw mmb bd x15 yy","vftab"], case_main:[] } ] },
				{ div:[], c:[ { input:["g","","case_vw_vt_","0","radio"] }, { div:["tabv gw mmb bd x15 yy","vw"] } ] },
			]}
		]},
		{ div:[], c:[ { input:["g","","case_vw_vt","3","radio"] }, { div:["tabv gw mmb bd","vftab"] } ] }, // case_vw
		{ div:[], c:[ { input:["g","","case_vw_vt","4","radio"] }, { p:["tabv","vdispo"] } ] },
	]}
]};

te["case_disposition_ufn"] = { ufn:["case_disposition_ufn"] };

te["case_reporter_is_client_ufn"] = { ufn:["case_reporter_is_client_ufn"] };

// -----

function case_disposition_ufn (el, u, a, r, m)
{
...
function case_reporter_is_client_ufn (el, u, a, r, m)
{
	var p = _(__(el,"ve"), "clients").childNodes[1];
	var el = nd (p, te["case_vw_client_r"], [], r, [0]);
}
...
function _post_reporter_is_client ()
{
	...
	if (f==false)
	{
		var el = _(p, "is_reporter", "input"); // delete client
		if (el) el.nextSibling.click ();
		return;
	}
	jso (p, o); // get case_id 
	jso (p_.childNodes[0], o_); // channel data
	jso (p_.childNodes[1], o_); // reporter data
	if (!o_.reporter_contact_id)
	{
		this.previousSibling.checked = false;
		alert ("Select / Create Reporter First");
		return;
	}
	o_["contact_id"] = o_["reporter_contact_id"];
	o_["case_id"] = o_[".id"];
	url (this.nextSibling.firstChild, "reporter_is_client", "clients", "", null, 2, o_, "POST"); // create client (from reporter_id)
}

function _postj_case (ev) { postj_case (this, this); boo(ev); }

function _postj_case_update (ev) { postj_case (this, elvp); boo(ev); }
