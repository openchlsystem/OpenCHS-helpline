...
[
	...
	{ div:["y15"], c:
	[
		{ s:["c w13 y","Role"] }, // tag-r_--o--::case_priority:0:1-priority-%0-
...
te["user_new_r"] = { user_ed_r_:["user_new-users","","_uvp"] };
...
[
	...
	[
		...
		{ div:["c l20","va"], ac:["ay","","_uvp","x y04 w05 gwd tc cbr bd","Cancel"], c:[ { p:["g","o"], arg:["",".id",""] } ] },
		{ div:["e"] }
	]}
]};
...
[
	...
	[
		...
		[ 
			//{ div:["c t"], c:[ { img:["","","/helpline/images/download.png", "16"] } ] },
			{ div:["c x y04","","+ New"] }, 
			{ div:["e"] }
		]},
...
[
        { div:["x25 yy s","vb"], c:
	[
		{ div:["c"], tab:["campaigns_mt","0","1",  "x02 y mr1 cd tab","user_main-users",  	"","Users"] },
