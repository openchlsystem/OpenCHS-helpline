...
[
	...
	[
        	...
        	[
	        	...
	        	{ p:["tabiv gws h03","o"], c:[ { input:["w21 x tt b05 gws","","age",null,"",""], ev:["","_contact_age"] } ] },
	        ]},
	        { div:[], c:
	        [
		...
		[
			...
			{ div:["tabiv","tag-r_--o-case_age_tag_txa-%1-age_group_id-%0-noop"], c: 
        		[
        	        	{ li:["gws b02","va"], c:[ { div:["","category_ls-subcategories"], ev:["_dd"], c: // ls
        	        	[
        	        		{ p:["c w18","o"], c:
					[ 
...
te["case_contact_edw_"] = { c:  // 
[
	{ div:["tt"], c:
	[
		{ div:["c w41"], case_txt_:[null,"gws w41 x tt b05","fname",null,null] }, 
	...
	{ div:["tt"], c:
	[
		{ div:["c w41"], case_txt_:["Nearest Landmark","gws w41 x tt b05","landmark",null,"Enter Nearest Landmark"] },
		{ div:["c w21 ll clk"], case_national_id_type_enum:["ID Type",null,null,null] },
		{ div:["c w21 ll clk"], case_txt_:["ID Number","gws w21 x tt b05","national_id",null,"Enter Reporter's ID Number"] },
		{ div:["e"] }
	]},
	{ div:["tt"], c:
	[
		{ div:["c w20"], case_txt_:["Phone Number","gws w20 x tt b05","phone",null,"Enter Reporter's Phone Number"] },
		{ div:["c w20 ll"], case_txt_:["Alternative Contact","gws w20 x tt b05","phone2",null,"Enter Alternate Contact"] },
...
[
	...
	{ div:["tt g"], c:
	[
		{ div:["c w20 clk"], case_national_id_type_enum:["ID Type",null,null,null] },
		{ div:["c w20 ll clk"], case_txt_:["ID Number","gws w21 x tt b05","national_id",null,"Enter Reporter's ID Number"] },
		{ div:["c w21 ll clk"], case_lang_enum:["Language",null,null,null] },
		{ div:["e"] }
	]},
...
[
	...
	{ div:["tt g"], c:
	[
		{ div:["c w20 ll clk"], case_vw_val_cat:["ID Type","",null] },
		{ div:["c w21 ll clk"], case_vw_val:["ID Number",null] },
		{ div:["c w21 ll clk"], case_vw_val_cat:["Language","",null] },
		{ div:["e"] }
	]},
	{ div:["tt g"], c:
	[
...
[
	...
	[
		...
		{ div:["xx yy"], kf_l:["Age", "tag_-r_--o--%8-category_id-age_group_id-%0-%8", "case_age_group_lc_main-subcategories", ":k:contacts_f:age_group_id", 
""," %1","category_id","age_group_id"," %0"," %1",   "case_age_group_root_id"] },
		{ div:["xx yy"], kf_l:["Gender","tag_-r_--o--%8-category_id-sex_id-%0-%8",  	"case_sex_lc_main-subcategories", ":k:contacts_f:sex_id", 
""," %1","category_id","sex_id"," %0"," %1",  "case_sex_root_id"] },
		{ div:["xx yy"], kf_l:["Location","tag_-r_--o--%8-category_id-location_id-%0-%8", "case_location_lc_main-subcategories",  ":k:contacts_f:location_id", 
""," %1","category_id","location_id"," %0"," %1", "case_location_level_root_id"] },
...
[
	{ k_a:["c w20","","cd","Full Name","da db","fullname",":k:contacts_k:fullname:2"] },
	{ k_a:["c w15","","cd","Phone","da db","phone",":k:contacts_k:phone:2"] },
	{ k_a:["c w15","","cd","Email","da db","email",":k:contacts_k:email:2"] },

	{ k_a:["c w15","","cd","Age","da db","age_group_id",":k:contacts_k:age_group_id:2"] },
	{ k_a:["c w15","","cd","Gender","da db","sex_id",":k:contacts_k:sex_id:2"] },
	{ k_a:["c w15","","cd","Location","da db","location_id",":k:contacts_k:location_id:2"] },	
...
function contact_age_group (p, v)
{
	...
	for (var i=0; i<a.length; i++)
	{
		...
		{
			el.innerHTML = "";
			nd (el, te["tag"], ["noop","%0","age_group_id","%8","case_age_tag_txa"], a[i], [5]);
			break
		}
	}
}
