...
[
	...
	[ 
		{ div:["c w01_"], s:["chk",""] },
		{ div:["x h02"], uhilite:["%8"] },
		{ div:["e"], c:[ { arg:["fullname-1","","%8"] }, { arg:["fullname_id-2","","%9"] } ] }
	]}
]};
...
[
	...
	{ arg:["","fullname_",":k:subcategories_k:fullname:2"] },
...
[
	...
	[ 
		{ p:["","txa"], c:
		[ 
			{ div:["w50 bb_b"], c:[ { input:["w50 x tt b05","fullname_","","","text",""], ev:["","_ky","","_uky"] } ] },
			{ u:[null] } // ky args
		]}
	]} ]},
	{ div:["","vd"], category_lc:[] }
...
[
	...
	{ div:["e"], c:[ { arg:["id-0","","%0"] }, { arg:["fullname-1","","%8"] }, { arg:["fullname_id-2","","%9"] } ] }
]};
...
[
	{ div:["y02","va"], ac:["","category_lsh-subcategories","_ne","xx y gws cb","%1"], c:[ { arg:["category_id","","%0"] } ] },
	{ p:["l20","vd"] }
]};
