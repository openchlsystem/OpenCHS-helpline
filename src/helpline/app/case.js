...
te["case_escalated_to_tag_txa"] = { case_enum_tag_txa_:["w37 xx tt b05","usn__","","escalated_to_id"] };
...
[
	{ div:["c w29 r20 "], case_justice_enum:["State in Justice System",":v:cases:justice_id",":v:cases:justice"," %0"] },
...
[
	{ div:["tt",""], u:[null,null] }, // reportered_by | reporter

	{ div:["",""], u:[null,null] }, // followup
...
[		
	...
	{ div:["x20 w130_"], c:
	[
		{ div:["c w45_ r50"], case_form_col_0:[null,null,null,null] },
...
te["case_ed"] = { case_form_:["%0", 
"case_form_reporter","reporters","case_form_followup","reporters_uuid",  
"case_ed-cases","Update",
"","_uvw", // "case_vw_id-cases-vfvw","_u", : breaks reporter_uuid // 
DISPOSITION_ID_FOLLOWUP] };

te["case_new"] = { case_form_:["NEW CASE", 
"case_form_reporter","reporters_uuid", 
"reporter_uuid","reporters_uuid", 
"case_new-cases","Create",
"","_uvw", 
DISPOSITION_ID_COMPLETE] };
		...
		{ div:["y15"], c:
                [
                        ...
                        [
                                ...
                                { u:["reporter_uuid_arg","reporters_uuid"] },
                        ] },
                        { div:["e"] }
                ]}
        ]}
...
[
	{ div:["c w30"], case_vw_val_cat:["Status in Justice System","",":v:cases:justice"] },
...
[
	...
	{ div:[], c:
	[
		{ u:["case_form_followup","reporters_uuid"] }, // load followuper if followup
	]},
...
te["case_vw_id_action_"] = { c:
[
	{ div:["w13","va"], s:["",""], c:
	[
		{ div:["c w10","va"], c:
		[
			{ ac:["mr_",null,"_vp","x08 y h02 n gws_ cb",""], c: 
			[
				{ s:["c micon h3","edit"] }, 
				{ s:["c xx s","Update"] }, 
				{ div:["e"], arg:["",".id","%0"] } 
			]},
			{ div:["g"], c:[ { arg:["","","activity_case_ufn-cases-vfvw--@"] } ] }
		]},
		{ ac:["c  w03","","_dd","x y h02 n gws_ cb",""], c:[ { div:["h02 w02 awb"] }] },
		{ div:["e"] }
	]},
	{ div:["dd w13 gws_ mt3","vdd"], c:
	[
		{ div:["","va"], ac:["",null,"_u","xx y cb",""], c: 
		[
			{ s:["","Edit"] },
			{ div:[], arg:["",".id","%0"] } 
		]},
...
te["case_vwa_id_action"] = { case_vw_id_action_:["case_update-reporters^uuid-^", "case_ed-reporters^uuid-vfvw"] }; 

te["case_vw_id_action"] = { case_vw_id_action_:["case_update-cases-^", "case_ed-cases-vfvw"] };
...
[	
	...
	[		
		...
		{ div:["d t r05"], c:
                [
			{ u:["case_vw_id_action"] }, // overridable
			{ u:["case_vwa_id_action","reporters_uuid","","reporters_uuid"] },
			{ u:["case_vwa_id_action","reporters_uuida","","reporters_uuida"] }
                ]},
