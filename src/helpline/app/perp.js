...
[
	...
	[
		...
		[
			{ div:[], c:
			[
				{ div:["d w03"], ac:["ao abs w03","perpetrator_del-perpetrators^del","_del","cb h2",""], c:
				[
					{ s:["x y h2 tc","&Cross;"] },
...
//	{ div:[], usub:["case_perpetrator_vw_sub_spouse,case_perpetrator_vw_sub_spouse,case_perpetrator_vw_sub_spouse,case_perpetrator_vw_sub_spouse,case_perpetrator_vw_sub_spouse","r_", ":v:perpetrators:marital_id", MARITAL_STATUS_WITH_SPOUSE_ID] },
