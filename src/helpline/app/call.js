...
te["call_r_qa_done"] = { div:[], c:
[
	{ ac:["","qa_vw_id-qas","_vp","xx tt b05 h01_ tr cb b",""], c:
	[ 
		{ s:["","Yes"] }, 
		{ div:[], c:[ { arg:["",".id",":v:calls:qa_id"] } ] } 
	]}
]};
...
[
	...
	{ div:["c w08"], s:["tt b05 h01_  xx tr",":h:ms:30:"] },
	...
	{ div:["c w12"], s:["tt b05 h01_ xx tr",":v:calls:tasks"] },
